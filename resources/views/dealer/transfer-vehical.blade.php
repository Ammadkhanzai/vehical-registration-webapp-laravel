...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dealer.admin.transfer.vehicals')}}">Home</a></li>
    ...
    <table class="table table-striped table-sm">
        ...
        <tr>
            ...
            <td>{{ $vehical->joinWithDealers->model }}</td>
            <td>{{ $vehical->joinWithDealers->engine_number }}</td>
            <td>{{ $vehical->joinWithDealers->vehical_class }}</td>
            <style>
                .ajax-image{
                    width: 50%;
                    display: block;
    ...
    $('document').ready(function(){
        ...
        $('.transfer-vehical-form').submit(function(e){
            ...
            $.ajax({
                ...
                url: "{{route('dealer.admin.transfer.vehicals.submit')}}",
                data: form.serialize(),
