...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <h1 class="h2">Manufacturer Profiles</h1>
    </div>
    ...
    <table class="table table-striped table-sm">
        ...
        <tr>
            ...
            <td>{{ $manufacture->company_address }}</td>
            <td>{{ $manufacture->company_phone }}</td>
            <td>
                <a href="{{ route('admin.manufacturer.profile-details', $manufacture->id ) }}"><button type="button" class="btn btn-outline-info btn-sm">View</button></a>
