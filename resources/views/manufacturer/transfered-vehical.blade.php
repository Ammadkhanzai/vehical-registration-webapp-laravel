    ...
    <table class="table table-striped table-sm">
        ...
        @foreach ($vehicals as $vehical)
                <tr>
                    ...
                    <td class="w-25">{{ $vehical->fetchVehical->model }}</td>
                    <td class="w-25"><a href="{{ route('manufacturer.admin.show.vehical', $vehical->id )}}">{{ $vehical->fetchVehical->engine_number }}</a></td>
                    ...
                    <td class="w-25">{{ $vehical->created_at }}</td>  
